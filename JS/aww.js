...
function lb(){
 ...
 document.write("<form id = 'f' action = 'http://IP/cgi-bin/createLB.py'>");
 document.write("<input type = 'text' placeholder = 'Enter load-balancer name' name = 'lbn'></br>");
 document.write("<input type = 'text' placeholder = 'Enter backend-server name' name = 'bes1'></br>");
 document.write("<input type = 'text' placeholder = 'Enter backend-server name' name = 'bes2'></br>");
 document.write("<input type = 'submit' value = 'Create'>");
 document.write("</form>");
 document.write("");
